      ...
      <section className="mb-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Spar penger</h3>
            <p className="text-gray-600 text-sm">
              Bytt til en fastprisavtale og få forutsigbare utgifter – ofte billigere enn spotpris over tid.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Trygghet</h3>
            <p className="text-gray-600 text-sm">
              Du slipper overraskelser på strømregningen og kan føle deg trygg på at du har en god avtale.
            </p>
          </div>
        </div>
      </section>
