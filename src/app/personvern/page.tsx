const PrivacyPolicyPage = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Personvern og informasjonskapsler</h1>
      
      <div className="prose prose-lg max-w-none">
        <p className="text-gray-600 mb-8">
          Denne avtalen ble sist endret: September 2024
        </p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">1. Behandling av personopplysninger ved bruk av våre tjenester</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">2. Behandling av personopplysninger ved henvendelser</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">3. Samarbeid med eksterne</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">4. Nyhetsbrev og markedsføring</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">5. Deling av personopplysninger</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">6. Dine rettigheter</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">8. Klager</h2>
          <p className="mb-4">
